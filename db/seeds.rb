...
movie_length: 118, genre: "Action", actor_list: "Paul Rudd, Evangeline Lilly, Micheal Douglas, Micheal Pena, David Dastmalchian" )
# Seed your database here
Review.create(rating: 9, text: "This movie was fantastic", movie: avengers)


Review.create(rating: 7, text: "This movie could have been better", movie: antman )
